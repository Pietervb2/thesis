...
This section outlines the mathematical modeling  of the thermodynamic and hydraulic behavior of the Decentralized Solution. Besides the theoretical model of every component also their respective physical constants are presented and where needed deducted. . 

It begins with an overview of the overall structure of the model. Subsequently, the hydraulic and thermodynamic modeling of the individual components is discussed. 
...
\subsubsection{Bypass control valve}\label{sec::overflowmech}
