...
EnergyPlus     & \makecell{Static, \\ dynamic}                                              & \makecell{\makecell{Static, \\ dynamic}}      & Yes& Yes & 1 min                 & 1/0/1/1     & Open source                                                       & Focus on thermal behavior in buildings and heating systems                                                     \\
Grid   Penguin & Dynamic                                                      & Static               & Yes & Yes & 1 hour                & 1/0/1/1     & Open source (python)                                              & Introduced as benchmark, rarely used                                                                           \\
IDA   ICE      & \makecell{Static, \\ dynamic}                                              & \makecell{Static, \\ dynamic}      & Yes & Yes & \textless 1   min\footnotemark[4] & 1/1/1/1     & Commercial, educational                                           & Focus on buildings and HVAC simulation                                                                         \\
OpenModelica   & \makecell{Static, \\ dynamic}                                              & \makecell{Static, \\ dynamic}      & Yes & Yes & \textless 1   min\footnotemark[4] & 1/1/1/1     & Open source                                                       & Modelica-based modeling and simulation environment                                                             \\
...
WANDA          & Static                                                       & \makecell{Static, \\ dynamic}      & Yes & Yes & \textless 1   min\footnotemark[3] & 1/1/1/1     & Commercial                                                        & Advanced water hammer software                                                                          
\end{tabular}
