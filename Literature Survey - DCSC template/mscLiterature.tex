...
\mscSubTitle{The Cooltower in Rotterdam as use-case}%
\mscKeyWords{thesis, msc, subject}% only used in PDF properties
\mscCoverPicture{figuresLIT/Cooltorenfoto.jpg}% to place a picture ( here the example COVER.eps) on the back of the cover page
%
%
